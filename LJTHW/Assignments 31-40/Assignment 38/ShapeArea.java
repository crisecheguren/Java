...
public class ShapeArea {
	public static void main(String[] args) {
		...
		System.out.println("Shape Area Calculator version 0.1 (c) 2015 Coog Sample Output, Inc.");
		...
		do {
			...
			if ( choice == 1 ) {
				...
				int l = keyboard.nextInt();
					if ( w != l ) {
						System.out.println("Not a square. Did you mean a rectangle?");
					} else {
						area = computeSquareArea(w);
						System.out.println("The area is " + area + ".");
					}
			}
